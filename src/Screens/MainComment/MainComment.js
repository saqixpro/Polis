    ...
    return this.state.pod ? (
      <View style={styles.mainContainer}>
        ...
        <ScrollView
          ...
          />
          <Text style={[styles.largeText, {width: '80%', alignSelf: 'center'}]}>
          ...
          style={[
            styles.horizontalContainer,
            {justifyContent: 'space-between', width: '85%', alignSelf: 'center'},
          ]}>
          <TouchableOpacity>
            <View style={[styles.bottomContainer]}>
              <Ionicons name="ios-chatbox-outline" size={20} color="gray" />
          ...
          <View style={[styles.bottomContainer]}>
            {this.liked(this.state.pod.id) ? (
              <TouchableOpacity onPress={() => this.unlikePost(this.state.pod.id)}>
              <Ionicons name="ios-heart" size={20} color="red" />
            </TouchableOpacity>
            ) : (
              <TouchableOpacity onPress={() => this.likePost(this.state.pod.id)}>
